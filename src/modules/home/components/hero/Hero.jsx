        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-40 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left">
            <div className="space-y-4">
              ...
              <p className="text-sm md:text-base lg:text-lg text-gray-200 max-w-md mx-auto lg:mx-0">
                {t('description')}
              </p>
            </div>
            <SearchBar />
          ...
          <div className="relative">
            <div className="space-y-4 max-w-md mx-auto lg:mx-0">
              <InterviewCard
                icon={FaFileAlt}
                title={t('interviewCards.resume.title')}
                description={t('interviewCards.resume.description')}
                color="#4CAF50"
              />
              <InterviewCard
                icon={FaPhoneAlt}
                title={t('interviewCards.telephoneInterview.title')}
                description={t('interviewCards.telephoneInterview.description')}
                color="#2196F3"
              />
              <InterviewCard
                icon={FaVideo}
                title={t('interviewCards.videoInterview.title')}
                description={t('interviewCards.videoInterview.description')}
                color="#FF9800"
              />
            </div>
            <div className="absolute hidden lg:block -right-20 lg:-right-96 -bottom-14 -z-10">
              <div className="relative w-64 h-64 lg:w-[450px] lg:h-[450px] rounded-full overflow-hidden shadow-lg">
                <Image
